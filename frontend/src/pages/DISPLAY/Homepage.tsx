  ...
  return (
    ...
    <div className="w-full h-full flex md:flex-col items-center justify-center px-[3.5rem] md:px-[2rem] mt-[3rem] gap-32">
        ...
        <div className="flex-1  flex flex-col gap-5 md:gap-5">
          ...
          <p className="text-[3.5rem] md:text-[2.5rem] sm:text-[1.5rem] leading-[65px] md:leading-[45px] sm:leading-[25px] pr-[2rem] md:pr-0 font-apercuB border " >Hi, my name is Yimika. I do photography, videography and content marketing. Let’s work together.</p>
